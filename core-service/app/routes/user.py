...
async def reset_password(data: ResetRequest, background_tasks: BackgroundTasks, session: Session = Depends(get_session)):
    await user.reset_user_password(data, background_tasks, session)
